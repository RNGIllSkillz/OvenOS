...
const I18N = {
  en: {
    ...
    msg_pid_ok: "Settings saved",
    msg_pid_err: "Error saving settings",
    ...
    tc2_label: "Part:",
    btn_fan: "FAN",
    lbl_cascade: "Use Cascade Control (Requires TC2)",
    lbl_pid_inner: "Air PID (Inner)",
    lbl_pid_outer: "Part PID (Outer)",
    air_target: "Air:",
  ...
  ru: {
    ...
    msg_pid_ok: "Настройки сохранены",
    msg_pid_err: "Ошибка сохранения",
    ...
    tc2_label: "Деталь:",
    btn_fan: "ВЕНТ.",
    lbl_cascade: "Каскадное управление (TC2)",
    lbl_pid_inner: "PID Воздуха (Внутр.)",
    lbl_pid_outer: "PID Детали (Внешн.)",
    air_target: "Воздух:",
